...
class Files {
  ...
  public void printall(final ArrayList<String> filenames, final int size) {
    ...
    System.out.println(
      "Maximum similarity is between " + file2 + " and " + file1); /* print statment for printing similarity files based on the
    tokens of the words fromed by all input documents*/
  }
}
/**
 * Class for solution.
...
public final class Solution {
   ...
   * { It is main function }.
   *
   * @param      args         The arguments which are passing as inputs.
   * @throws     IOException  { It throws exception when an any handled error is happened. }
   */
